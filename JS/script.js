...
function ganhou(){
    ...
    var img_changer = '<div id="img_Perfil"><img src="img/perfil_ganhou.png" alt=""></div>';
    document.getElementById("img_Perfil").innerHTML = img_changer;
    <div id="msg_fim"><div id="resposta_fim_de_jogo" style="display: flex"><p id="text1">Parabéns! Você conseguiu dar um golpe no golpe com astúcia e perspicácia. Sua atenção aos detalhes e cautela foram impressionantes.Continue assim, sempre questionando e verificando antes de tomar decisões importantes. Lembre-se, a melhordefesa contra golpes é o conhecimento e a prevenção. Fique seguro e esteja um passo à frente dos golpistas!</p></div><div id="btn_final_div" style="display: flex"><button><p id="text1">Tentar novamente</p></button></div></div></div>
}
*/
